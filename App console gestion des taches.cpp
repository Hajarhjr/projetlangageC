...

{
   int choix;
    while(choix!=7){
    	...
    	printf("tapper 3 pour Modifier une T?che  \n");
    	printf("tapper 4 pour Supprimer  une T?che  \n");
    	printf("tapper 5 pour Ordonner les T?ches \n");
    	printf("tapper 6 pour Filtrer les T?ches \n ");
